        ...
        try {
            ...
            if (CreateNewCommunity) {
               ...
               let Auth =  await authService.createUser({
                ...
                await permissionService.createPermission(Default_Organization_Permissions, String(Auth._id))
            }


            SendResponse.SuccessResponse(res, CreateNewCommunity , AuthConstant.COMMUNITY_ACCOUNT_CREATED)
        } catch (error) {
